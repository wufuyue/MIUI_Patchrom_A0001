...
.method public makeNewLayoutInflater(Landroid/content/Context;)Landroid/view/LayoutInflater;
    ...
    .annotation build Landroid/annotation/OppoHook;
        ...
        note = "Suying.You@Plf.SDK : Add for modify the layout of contextMenu"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation

    .prologue
    .line 92
    invoke-static {p1}, Lcom/android/internal/policy/impl/ColorPhoneLayoutInflater;->newInstance(Landroid/content/Context;)Lcom/android/internal/policy/impl/PhoneLayoutInflater;
