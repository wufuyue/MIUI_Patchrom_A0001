...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :cond_2
    const-string v2, "android.net.wifi.CONNECT_MODE_CHANGE"
    ...
    # setter for: Landroid/net/CaptivePortalTracker;->bManualConnect:Z
    invoke-static {v2, v3}, Landroid/net/CaptivePortalTracker;->access$602(Landroid/net/CaptivePortalTracker;Z)Z
    ...
    iget-object v4, p0, Landroid/net/CaptivePortalTracker$1;->this$0:Landroid/net/CaptivePortalTracker;

    invoke-virtual {v4}, Landroid/net/CaptivePortalTracker;->getName()Ljava/lang/String;
    ...
    const-string v4, " bManualConnect is "
    ...
    invoke-static {v4}, Landroid/net/CaptivePortalTracker;->access$600(Landroid/net/CaptivePortalTracker;)Z
