...
.method public enter()V
    ...
    invoke-static {v3}, Landroid/net/CaptivePortalTracker;->access$2404(Landroid/net/CaptivePortalTracker;)I
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v6, v7}, Landroid/net/CaptivePortalTracker;->access$2500(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)V
    ...
    invoke-static {v6}, Landroid/net/CaptivePortalTracker;->access$1100(Landroid/net/CaptivePortalTracker;)V
    ...
    invoke-static {v7}, Landroid/net/CaptivePortalTracker;->access$2400(Landroid/net/CaptivePortalTracker;)I
    ...
    invoke-static {v7}, Landroid/net/CaptivePortalTracker;->access$2600(Landroid/net/CaptivePortalTracker;)Ljava/lang/String;

    move-result-object v7

    # invokes: Landroid/net/CaptivePortalTracker;->lookupHost(Ljava/lang/String;)Ljava/net/InetAddress;
    invoke-static {v6, v7}, Landroid/net/CaptivePortalTracker;->access$2700(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)Ljava/net/InetAddress;
    ...
    invoke-static {v6, v3}, Landroid/net/CaptivePortalTracker;->access$2800(Landroid/net/CaptivePortalTracker;Ljava/net/InetAddress;)Z
    ...
    # invokes: Landroid/net/CaptivePortalTracker;->log(Ljava/lang/String;)V
    invoke-static {v5, v6}, Landroid/net/CaptivePortalTracker;->access$2900(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)V
    ...
    # getter for: Landroid/net/CaptivePortalTracker;->mNetworkInfo:Landroid/net/NetworkInfo;
    invoke-static {v6}, Landroid/net/CaptivePortalTracker;->access$1200(Landroid/net/CaptivePortalTracker;)Landroid/net/NetworkInfo;

    move-result-object v6

    # invokes: Landroid/net/CaptivePortalTracker;->notifyPortalCheckCompleted(Landroid/net/NetworkInfo;Z)V
    invoke-static {v5, v6, v0}, Landroid/net/CaptivePortalTracker;->access$3100(Landroid/net/CaptivePortalTracker;Landroid/net/NetworkInfo;Z)V
    ...
    # getter for: Landroid/net/CaptivePortalTracker;->bManualConnect:Z
    invoke-static {v5}, Landroid/net/CaptivePortalTracker;->access$600(Landroid/net/CaptivePortalTracker;)Z
    ...
    invoke-static {v6}, Landroid/net/CaptivePortalTracker;->access$3200(Landroid/net/CaptivePortalTracker;)Ljava/lang/String;
    ...
    invoke-static {v6}, Landroid/net/CaptivePortalTracker;->access$3400(Landroid/net/CaptivePortalTracker;)Lcom/android/internal/util/State;

    move-result-object v6

    # invokes: Landroid/net/CaptivePortalTracker;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v5, v6}, Landroid/net/CaptivePortalTracker;->access$3500(Landroid/net/CaptivePortalTracker;Lcom/android/internal/util/IState;)V
    ...
    # invokes: Landroid/net/CaptivePortalTracker;->log(Ljava/lang/String;)V
    invoke-static {v5, v6}, Landroid/net/CaptivePortalTracker;->access$3000(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)V
    ...
    invoke-static {v5}, Landroid/net/CaptivePortalTracker;->access$3300(Landroid/net/CaptivePortalTracker;)Landroid/net/IConnectivityManager;
    ...
    # getter for: Landroid/net/CaptivePortalTracker;->mNetworkInfo:Landroid/net/NetworkInfo;
    invoke-static {v8}, Landroid/net/CaptivePortalTracker;->access$1200(Landroid/net/CaptivePortalTracker;)Landroid/net/NetworkInfo;
    ...
    # getter for: Landroid/net/CaptivePortalTracker;->mUrl:Ljava/lang/String;
    invoke-static {v9}, Landroid/net/CaptivePortalTracker;->access$3200(Landroid/net/CaptivePortalTracker;)Ljava/lang/String;
