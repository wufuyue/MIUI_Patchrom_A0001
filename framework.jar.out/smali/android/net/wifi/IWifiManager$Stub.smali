...
.field static final TRANSACTION_blockClient:I = 0x34
...
.field static final TRANSACTION_getClientIp:I = 0x33
...
.field static final TRANSACTION_getHotspotClients:I = 0x32
...
.field static final TRANSACTION_loadFtmDriver:I = 0x29
...
.field static final TRANSACTION_suspendNotification:I = 0x37

.field static final TRANSACTION_unblockClient:I = 0x35

.field static final TRANSACTION_unloadFtmDriver:I = 0x2a
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 568
    .local v8, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/net/wifi/cmcc/HotspotClient;>;"
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 574
    .end local v8    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/net/wifi/cmcc/HotspotClient;>;"
    :sswitch_33
    const-string v9, "android.net.wifi.IWifiManager"
    ...
    .line 587
    sget-object v9, Landroid/net/wifi/cmcc/HotspotClient;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 592
    .local v0, "_arg0":Landroid/net/wifi/cmcc/HotspotClient;
    :goto_25
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->blockClient(Landroid/net/wifi/cmcc/HotspotClient;)Z
    ...
    .line 590
    .end local v0    # "_arg0":Landroid/net/wifi/cmcc/HotspotClient;
    .end local v4    # "_result":Z
    :cond_24
    const/4 v0, 0x0

    .restart local v0    # "_arg0":Landroid/net/wifi/cmcc/HotspotClient;
    goto :goto_25
    ...
    .restart local v0    # "_arg0":Landroid/net/wifi/cmcc/HotspotClient;
    :goto_27
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->unblockClient(Landroid/net/wifi/cmcc/HotspotClient;)Z
