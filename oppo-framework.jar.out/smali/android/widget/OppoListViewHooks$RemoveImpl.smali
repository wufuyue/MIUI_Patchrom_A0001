...
.method private getAndAddView(IIZ)Landroid/widget/OppoListViewHooks$RemoveImpl$RemoveView;
    ...
    .prologue
    .line 570
    invoke-direct/range {p0 .. p1}, Landroid/widget/OppoListViewHooks$RemoveImpl;->getRemoveItem(I)Landroid/widget/OppoListViewHooks$RemoveImpl$RemoveItem;

    move-result-object v14

    .line 571
    .local v14, "info":Landroid/widget/OppoListViewHooks$RemoveImpl$RemoveItem;
    invoke-virtual {v14}, Landroid/widget/OppoListViewHooks$RemoveImpl$RemoveItem;->getPos()I

    move-result v3

    .line 572
    .local v3, "pos":I
    invoke-virtual {v14}, Landroid/widget/OppoListViewHooks$RemoveImpl$RemoveItem;->getView()Landroid/view/View;
    ...
    # invokes: Landroid/widget/OppoListViewHooks;->getListPaddingLeft()I
    invoke-static {v4}, Landroid/widget/OppoListViewHooks;->access$1800(Landroid/widget/OppoListViewHooks;)I

    move-result v6

    iget-object v4, p0, Landroid/widget/OppoListViewHooks$RemoveImpl;->this$0:Landroid/widget/OppoListViewHooks;

    # invokes: Landroid/widget/OppoListViewHooks;->getIsScrap()[Z
    invoke-static {v4}, Landroid/widget/OppoListViewHooks;->access$1900(Landroid/widget/OppoListViewHooks;)[Z
    ...
    # invokes: Landroid/widget/OppoListViewHooks;->setupChild(Landroid/view/View;IIZIZZ)V
    invoke-static/range {v1 .. v8}, Landroid/widget/OppoListViewHooks;->access$2000(Landroid/widget/OppoListViewHooks;Landroid/view/View;IIZIZZ)V
    ...
    invoke-static {v1, v4, v5}, Lcom/oppo/util/OppoLog;->e(ZLjava/lang/String;Ljava/lang/String;)V

    .line 583
    new-instance v8, Landroid/widget/OppoListViewHooks$RemoveImpl$RemoveView;
    ...
    invoke-direct/range {v8 .. v13}, Landroid/widget/OppoListViewHooks$RemoveImpl$RemoveView;-><init>(Landroid/widget/OppoListViewHooks$RemoveImpl;Landroid/view/View;IIZ)V
