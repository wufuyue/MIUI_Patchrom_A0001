...
.method protected onLayout(ZIIII)V
    ...
    .line 188
    .local v3, "arrowView":Landroid/view/View;
    const/4 v0, 0x0

    .line 189
    .local v0, "arrowHide":Landroid/view/View;
    iget-boolean v5, p0, Landroid/widget/OppoTranslatePanelView;->mIsArrowUp:Z

    if-eqz v5, :cond_0

    .line 190
    iget-object v3, p0, Landroid/widget/OppoTranslatePanelView;->mArrowUpView:Landroid/view/View;

    .line 191
    iget v5, p0, Landroid/widget/OppoTranslatePanelView;->mUpArrowTopOffset:I
    ...
    iget v6, p0, Landroid/widget/OppoTranslatePanelView;->mUpArrowBottomOffset:I

    sub-int v4, v5, v6

    .line 198
    :goto_0
    iget v5, p0, Landroid/widget/OppoTranslatePanelView;->mArrowPos:I
    ...
    .line 205
    :goto_1
    invoke-direct {p0, v3, v1, v2}, Landroid/widget/OppoTranslatePanelView;->layoutChild(Landroid/view/View;II)V
    ...
    invoke-direct {p0, v5, v6, v4}, Landroid/widget/OppoTranslatePanelView;->layoutChild(Landroid/view/View;II)V
    ...
    :cond_0
    iget-object v3, p0, Landroid/widget/OppoTranslatePanelView;->mArrowDownView:Landroid/view/View;

    .line 195
    iget v4, p0, Landroid/widget/OppoTranslatePanelView;->mDownArrowTopOffset:I
    ...
    iget v6, p0, Landroid/widget/OppoTranslatePanelView;->mDownArrowBottomOffset:I
