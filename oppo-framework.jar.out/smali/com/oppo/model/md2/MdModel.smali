...
.method private native md2FillRenderBuffer(ILcom/oppo/model/md2/MdModel$Config;Lcom/oppo/model/md2/MdModel$RenderBuffer;)V
.end method

.method private native md2FillRenderBufferII(ILcom/oppo/model/md2/MdModel$Config;Lcom/oppo/model/md2/MdModel$RenderBuffer;)V
.end method

.method private native md2GetCurrentFrames(I)F
.end method

.method private native md2GetFrame(IIIF)F
.end method

.method private native md2GetMaxCoordinate(IFI[I)F
.end method

.method private native md2GetMinCoordinate(IFI[I)F
.end method

.method private native md2GetNumTriangles(I)I
.end method

.method private native md2GetRegionNormalBuffer(ILjava/nio/Buffer;)V
.end method

.method private native md2GetRegionVertexBuffer(ILjava/nio/Buffer;)V
.end method

.method private native md2GetShadowColorBuffer(ILjava/nio/Buffer;)V
.end method

.method private native md2GetSphereCenter(I[F)V
.end method

.method private native md2GetSphereRadius(I)F
.end method

.method private native md2GetTextureCoordsBuffer(ILjava/nio/Buffer;)V
.end method

.method private native md2GetTotalFrames(I)I
.end method

.method private native md2LoadModel(I[BLcom/oppo/model/md2/MdModel$Config;[I)I
.end method

.method private native md2ReleaseModel(I)V
.end method

.method private native md2SetDirtFlag(IZ)V
.end method

.method private native md2SetFrame(IF)V
.end method

.method private native md2SetKeyPosition(IFF)V
.end method

.method private native md2SetKeyVertex(II)V
.end method

.method private native md2SetShadowHeight(IF)V
.end method

.method private native md2SetShadowParameters(IFF)V
.end method
...
.method public Load(Ljava/io/InputStream;ZZZZZI)Z
    ...
    invoke-direct {p0, v1, v0, v6, v3}, Lcom/oppo/model/md2/MdModel;->md2LoadModel(I[BLcom/oppo/model/md2/MdModel$Config;[I)I
    ...
    iput v6, p0, Lcom/oppo/model/md2/MdModel;->mRef:I
    :try_end_0
...
.method public fillRenderBuffer(ZFF)V
    ...
    .line 288
    iget v0, p0, Lcom/oppo/model/md2/MdModel;->mRef:I

    iget-object v1, p0, Lcom/oppo/model/md2/MdModel;->mConfig:Lcom/oppo/model/md2/MdModel$Config;

    iget-object v2, p0, Lcom/oppo/model/md2/MdModel;->mRenderBuffer:Lcom/oppo/model/md2/MdModel$RenderBuffer;

    invoke-direct {p0, v0, v1, v2}, Lcom/oppo/model/md2/MdModel;->md2FillRenderBuffer(ILcom/oppo/model/md2/MdModel$Config;Lcom/oppo/model/md2/MdModel$RenderBuffer;)V
...
.method public fillRenderBuffer(ZZFFF)V
    ...
    invoke-direct {p0, v0, v1, v2}, Lcom/oppo/model/md2/MdModel;->md2FillRenderBufferII(ILcom/oppo/model/md2/MdModel$Config;Lcom/oppo/model/md2/MdModel$RenderBuffer;)V
...
.method public getCurrentFrames()F
    ...
    invoke-direct {p0, v0}, Lcom/oppo/model/md2/MdModel;->md2GetCurrentFrames(I)F
...
.method public getFrame(IIF)F
    ...
    invoke-direct {p0, v0, p1, p2, p3}, Lcom/oppo/model/md2/MdModel;->md2GetFrame(IIIF)F
...
.method public getMaxCoordinate(FI[I)F
    ...
    invoke-direct {p0, v0, p1, p2, p3}, Lcom/oppo/model/md2/MdModel;->md2GetMaxCoordinate(IFI[I)F
...
.method public getMinCoordinate(FI[I)F
    ...
    invoke-direct {p0, v0, p1, p2, p3}, Lcom/oppo/model/md2/MdModel;->md2GetMinCoordinate(IFI[I)F
...
.method public getNumTriangles()I
    ...
    invoke-direct {p0, v0}, Lcom/oppo/model/md2/MdModel;->md2GetNumTriangles(I)I
...
.method public getRegionNormalBuf()Ljava/nio/FloatBuffer;
    ...
    iget-object v1, p0, Lcom/oppo/model/md2/MdModel;->mpRegionBufNormal:Ljava/nio/FloatBuffer;

    invoke-direct {p0, v0, v1}, Lcom/oppo/model/md2/MdModel;->md2GetRegionNormalBuffer(ILjava/nio/Buffer;)V
...
.method public getRegionVertexBuf()Ljava/nio/FloatBuffer;
    ...
    iget-object v1, p0, Lcom/oppo/model/md2/MdModel;->mpRegionBufVertices:Ljava/nio/FloatBuffer;

    invoke-direct {p0, v0, v1}, Lcom/oppo/model/md2/MdModel;->md2GetRegionVertexBuffer(ILjava/nio/Buffer;)V
...
.method public getShadowColorBuf()Ljava/nio/FloatBuffer;
    ...
    iget-object v1, p0, Lcom/oppo/model/md2/MdModel;->mRenderBuffer:Lcom/oppo/model/md2/MdModel$RenderBuffer;

    iget-object v1, v1, Lcom/oppo/model/md2/MdModel$RenderBuffer;->colorShadowBuffer:Ljava/nio/FloatBuffer;

    invoke-direct {p0, v0, v1}, Lcom/oppo/model/md2/MdModel;->md2GetShadowColorBuffer(ILjava/nio/Buffer;)V
...
.method public getSphereCenter()Lcom/oppo/model/lib/Vector3f;
    ...
    invoke-direct {p0, v0, v1}, Lcom/oppo/model/md2/MdModel;->md2GetSphereCenter(I[F)V
...
.method public getSphereRadius()F
    ...
    invoke-direct {p0, v0}, Lcom/oppo/model/md2/MdModel;->md2GetSphereRadius(I)F
...
.method public getTextureCoordsBuf()Ljava/nio/FloatBuffer;
    ...
    iget-object v1, v1, Lcom/oppo/model/md2/MdModel$RenderBuffer;->texCoordBuffer:Ljava/nio/FloatBuffer;

    invoke-direct {p0, v0, v1}, Lcom/oppo/model/md2/MdModel;->md2GetTextureCoordsBuffer(ILjava/nio/Buffer;)V
...
.method public getTotalFrames()I
    ...
    invoke-direct {p0, v0}, Lcom/oppo/model/md2/MdModel;->md2GetTotalFrames(I)I
...
.method public releaseModel()V
    ...
    invoke-direct {p0, v0}, Lcom/oppo/model/md2/MdModel;->md2ReleaseModel(I)V
...
.method public setDirtFlag(Z)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/oppo/model/md2/MdModel;->md2SetDirtFlag(IZ)V
...
.method public setFrame(F)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/oppo/model/md2/MdModel;->md2SetFrame(IF)V
...
.method public setKeyPosition(FF)V
    ...
    invoke-direct {p0, v0, p1, p2}, Lcom/oppo/model/md2/MdModel;->md2SetKeyPosition(IFF)V
...
.method public setKeyVertex(I)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/oppo/model/md2/MdModel;->md2SetKeyVertex(II)V
...
.method public setShadowHeight(F)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/oppo/model/md2/MdModel;->md2SetShadowHeight(IF)V
...
.method public setShadowParameters(FF)V
    ...
    invoke-direct {p0, v0, p1, p2}, Lcom/oppo/model/md2/MdModel;->md2SetShadowParameters(IFF)V
