...
.method private initMaterials()V
    ...
    .line 591
    .local v7, "shininess":[F
    const/4 v8, 0x0

    .line 592
    .local v8, "transparency":[F
    const/4 v9, 0x0
    ...
    .line 595
    .local v10, "texture":[B
    new-array v0, v11, [Lcom/oppo/model/ms3d/MsMaterial;

    iput-object v0, p0, Lcom/oppo/model/ms3d/MsModel;->mMsMaterial:[Lcom/oppo/model/ms3d/MsMaterial;
    ...
    new-instance v1, Lcom/oppo/model/ms3d/MsMaterial;

    invoke-direct {v1}, Lcom/oppo/model/ms3d/MsMaterial;-><init>()V

    aput-object v1, v0, v2

    .line 608
    iget v1, p0, Lcom/oppo/model/ms3d/MsModel;->mRef:I

    move-object v0, p0

    invoke-direct/range {v0 .. v10}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetMaterial(II[F[F[F[F[F[F[S[B)V
    ...
    invoke-virtual {v0, v3}, Lcom/oppo/model/ms3d/MsMaterial;->setAmbient([F)V
    ...
    invoke-virtual {v0, v4}, Lcom/oppo/model/ms3d/MsMaterial;->setDiffuse([F)V
    ...
    invoke-virtual {v0, v5}, Lcom/oppo/model/ms3d/MsMaterial;->setSpecular([F)V
    ...
    invoke-virtual {v0, v6}, Lcom/oppo/model/ms3d/MsMaterial;->setEmissive([F)V
    ...
    invoke-virtual {v0, v1}, Lcom/oppo/model/ms3d/MsMaterial;->setShininess(F)V
    ...
    invoke-virtual {v0, v1}, Lcom/oppo/model/ms3d/MsMaterial;->setTransparency(F)V
    ...
    aget-short v1, v9, v13

    invoke-virtual {v0, v1}, Lcom/oppo/model/ms3d/MsMaterial;->setMode(S)V
    ...
    invoke-static {v10}, Lcom/oppo/model/lib/ModelUtils;->makeSafeString([B)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/oppo/model/ms3d/MsMaterial;->setTexture(Ljava/lang/String;)V
...
.method private native ms3dContainsAnimation(I)I
.end method

.method private native ms3dFillRenderBuffer(ILcom/oppo/model/ms3d/MsModel$Config;[Lcom/oppo/model/ms3d/MsModel$RenderBuffer;)V
.end method

.method private native ms3dGetAlphaRef(I)F
.end method

.method private native ms3dGetAnimationFps(I)F
.end method

.method private native ms3dGetGroupTexture(II[B)I
.end method

.method private native ms3dGetMaterial(II[F[F[F[F[F[F[S[B)V
.end method

.method private native ms3dGetMaterialIndex(II)B
.end method

.method private native ms3dGetNumGroups(I)I
.end method

.method private native ms3dGetNumMaterials(I)I
.end method

.method private native ms3dGetNumTriangles(II)I
.end method

.method private native ms3dGetShadowColorBuffer(IILjava/nio/Buffer;)V
.end method

.method private native ms3dGetShadowVertexBuffer(IILjava/nio/Buffer;)V
.end method

.method private native ms3dGetSphereCenter(I[F)V
.end method

.method private native ms3dGetSphereMax(I[F)V
.end method

.method private native ms3dGetSphereMin(I[F)V
.end method

.method private native ms3dGetSphereRadius(I)F
.end method

.method private native ms3dGetTextureCoordsBuffer(IILjava/nio/Buffer;)V
.end method

.method private native ms3dGetTextureInfo(II[B)I
.end method

.method private native ms3dGetTotalFrames(I)I
.end method

.method private native ms3dGetTransparencyMode(I)I
.end method

.method private native ms3dIntersect(I[F[F)I
.end method

.method private native ms3dLoadModel(I[BLcom/oppo/model/ms3d/MsModel$Config;[I)I
.end method

.method private native ms3dReleaseModel(I)V
.end method

.method private native ms3dSetDirtFlag(II)V
.end method

.method private native ms3dSetFrame(IF)V
.end method

.method private native ms3dSetShadowHeight(IF)V
.end method

.method private native ms3dSetShadowParameters(IFF)V
.end method

.method private native ms3dSetupJoints(I)V
.end method
...
.method public Load(Ljava/io/InputStream;Z)Z
    ...
    invoke-direct {p0, v1, v0, v7, v3}, Lcom/oppo/model/ms3d/MsModel;->ms3dLoadModel(I[BLcom/oppo/model/ms3d/MsModel$Config;[I)I
    ...
    iput v7, p0, Lcom/oppo/model/ms3d/MsModel;->mRef:I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 215
    iget v6, p0, Lcom/oppo/model/ms3d/MsModel;->mRef:I

    invoke-direct {p0, v6}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetNumGroups(I)I
...
.method public containsAnimation()I
    ...
    .prologue
    .line 275
    iget v0, p0, Lcom/oppo/model/ms3d/MsModel;->mRef:I

    invoke-direct {p0, v0}, Lcom/oppo/model/ms3d/MsModel;->ms3dContainsAnimation(I)I
...
.method public fillRenderBuffer(IFF)V
    ...
    invoke-direct {p0, v0, v1, v2}, Lcom/oppo/model/ms3d/MsModel;->ms3dFillRenderBuffer(ILcom/oppo/model/ms3d/MsModel$Config;[Lcom/oppo/model/ms3d/MsModel$RenderBuffer;)V
...
.method public getAlphaRef()F
    ...
    invoke-direct {p0, v0}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetAlphaRef(I)F
...
.method public getAnimationFps()F
    ...
    invoke-direct {p0, v0}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetAnimationFps(I)F
...
.method public getGroupTexture(I[B)I
    ...
    invoke-direct {p0, v0, p1, p2}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetGroupTexture(II[B)I
...
.method public getMaterialIndex(I)B
    ...
    invoke-direct {p0, v0, p1}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetMaterialIndex(II)B
...
.method public getNumMaterials()I
    ...
    invoke-direct {p0, v0}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetNumMaterials(I)I
...
.method public getNumTriangles(I)I
    ...
    invoke-direct {p0, v0, p1}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetNumTriangles(II)I
...
.method public getShadowColorBuf(I)Ljava/nio/FloatBuffer;
    ...
    iget-object v1, p0, Lcom/oppo/model/ms3d/MsModel;->mMsGroup:[Lcom/oppo/model/ms3d/MsGroup;

    aget-object v1, v1, p1

    iget-object v1, v1, Lcom/oppo/model/ms3d/MsGroup;->mShadowColorBuffer:Ljava/nio/FloatBuffer;

    invoke-direct {p0, v0, p1, v1}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetShadowColorBuffer(IILjava/nio/Buffer;)V
...
.method public getShadowVertexBuf(I)Ljava/nio/FloatBuffer;
    ...
    iget-object v1, v1, Lcom/oppo/model/ms3d/MsGroup;->mShadowVertexBuffer:Ljava/nio/FloatBuffer;

    invoke-direct {p0, v0, p1, v1}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetShadowVertexBuffer(IILjava/nio/Buffer;)V
...
.method public getSphereCenter()Lcom/oppo/model/lib/Vector3f;
    ...
    invoke-direct {p0, v1, v0}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetSphereCenter(I[F)V
...
.method public getSphereMax()Lcom/oppo/model/lib/Vector3f;
    ...
    invoke-direct {p0, v1, v0}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetSphereMax(I[F)V
...
.method public getSphereMin()Lcom/oppo/model/lib/Vector3f;
    ...
    invoke-direct {p0, v1, v0}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetSphereMin(I[F)V
...
.method public getSphereRadius()F
    ...
    invoke-direct {p0, v0}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetSphereRadius(I)F
...
.method public getTextureCoordsBuf(I)Ljava/nio/FloatBuffer;
    ...
    iget-object v1, v1, Lcom/oppo/model/ms3d/MsGroup;->mCoordBuffer:Ljava/nio/FloatBuffer;

    invoke-direct {p0, v0, p1, v1}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetTextureCoordsBuffer(IILjava/nio/Buffer;)V
...
.method public getTextureInfo(I[B)I
    ...
    invoke-direct {p0, v0, p1, p2}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetTextureInfo(II[B)I
...
.method public getTotalFrames()I
    ...
    invoke-direct {p0, v0}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetTotalFrames(I)I
...
.method public getTransparencyMode()I
    ...
    invoke-direct {p0, v0}, Lcom/oppo/model/ms3d/MsModel;->ms3dGetTransparencyMode(I)I
...
.method public releaseModel()V
    ...
    invoke-direct {p0, v0}, Lcom/oppo/model/ms3d/MsModel;->ms3dReleaseModel(I)V
...
.method public setDirtFlag(I)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/oppo/model/ms3d/MsModel;->ms3dSetDirtFlag(II)V
...
.method public setFrame(F)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/oppo/model/ms3d/MsModel;->ms3dSetFrame(IF)V
...
.method public setShadowHeight(F)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/oppo/model/ms3d/MsModel;->ms3dSetShadowHeight(IF)V
...
.method public setShadowParameters(FF)V
    ...
    invoke-direct {p0, v0, p1, p2}, Lcom/oppo/model/ms3d/MsModel;->ms3dSetShadowParameters(IFF)V
...
.method public setupJoints()V
    ...
    invoke-direct {p0, v0}, Lcom/oppo/model/ms3d/MsModel;->ms3dSetupJoints(I)V
