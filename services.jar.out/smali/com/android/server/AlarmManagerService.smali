...
.field private static final DEBUG_BATCH_MASK:I = 0x2

.field private static final DEBUG_LOCAL_LOGV_MASK:I = 0x1

.field private static DEBUG_VALIDATE:Z = false

.field private static final DEBUG_VALIDATE_MASK:I = 0x3
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .annotation build Landroid/annotation/OppoHook;
        ...
        note = "liumei@Plf.Framework,2014.07.29:Modify for inexact alarm"
    ...
    .line 719
    :cond_0
    new-instance v3, Lcom/android/server/AlarmManagerService$AlarmTimeoutCheckReceiver;

    invoke-direct {v3, p0, p1}, Lcom/android/server/AlarmManagerService$AlarmTimeoutCheckReceiver;-><init>(Lcom/android/server/AlarmManagerService;Landroid/content/Context;)V
    ...
    invoke-static {v3, p0}, Lcom/android/server/OppoAlarmManagerHelper;->init(Landroid/content/Context;Lcom/android/server/AlarmManagerService;)V
...
.method static synthetic access$1900(Lcom/android/server/AlarmManagerService;)Lcom/android/server/AlarmManagerService$AlarmTimeoutCheckReceiver;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/AlarmManagerService;

    .prologue
    .line 96
    iget-object v0, p0, Lcom/android/server/AlarmManagerService;->mAlarmTimeoutCheckReceiver:Lcom/android/server/AlarmManagerService$AlarmTimeoutCheckReceiver;
...
.method private final getStatsLocked(Landroid/app/PendingIntent;)Lcom/android/server/AlarmManagerService$BroadcastStats;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/AlarmManagerService$BroadcastStats;-><init>(Ljava/lang/String;I)V
...
.method private updateLogMask(Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 178
    const-string v0, "  DEBUG_BATCH(0x%1$h)=%2$b"
    ...
    .line 179
    const-string v0, "  DEBUG_VALIDATE(0x%1$h)=%2$b"
...
.method public set(IJJJLandroid/app/PendingIntent;Landroid/os/WorkSource;)V
    ...
    invoke-static/range {v0 .. v9}, Lcom/android/server/OppoAlarmManagerHelper;->set(IJJJLandroid/app/PendingIntent;Landroid/os/WorkSource;Z)V
