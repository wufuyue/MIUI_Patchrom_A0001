...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/LightsService;)V
    ...
    .line 151
    iput v3, p0, Lcom/android/server/BatteryService;->mBatteryRequestPoweroff:I

    .line 153
    iput v2, p0, Lcom/android/server/BatteryService;->mMaxChargeCurrent:I
    ...
    .line 155
    iput v2, p0, Lcom/android/server/BatteryService;->mMaxChargeTemperature:I

    .line 161
    iput-object v6, p0, Lcom/android/server/BatteryService;->mOppoUsageService:Landroid/os/IOppoUsageService;

    .line 162
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->isServiceBinded:Z

    .line 172
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->mSentLowBatteryBroadcast:Z

    .line 178
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->mBatteryLightFlashing:Z
    ...
    invoke-direct {v1, p0, v6}, Lcom/android/server/BatteryService$BatteryListener;-><init>(Lcom/android/server/BatteryService;Lcom/android/server/BatteryService$1;)V
    ...
    :cond_1
    iput-boolean v5, p0, Lcom/android/server/BatteryService;->mBatteryLightFlashing:Z
...
.method private processValuesLocked()V
    ...
    .line 458
    .local v14, "serviceBinder":Landroid/os/IBinder;
    if-eqz v14, :cond_3

    .line 459
    invoke-static {v14}, Landroid/os/IOppoUsageService$Stub;->asInterface(Landroid/os/IBinder;)Landroid/os/IOppoUsageService;
    ...
    .line 474
    .end local v14    # "serviceBinder":Landroid/os/IBinder;
    :cond_3
    :goto_3
    ...
    .line 466
    .restart local v14    # "serviceBinder":Landroid/os/IBinder;
    :catch_0
    move-exception v9

    .line 467
    .local v9, "exce":Landroid/os/RemoteException;
    sget-object v0, Lcom/android/server/BatteryService;->TAG:Ljava/lang/String;
    ...
    .line 479
    .end local v9    # "exce":Landroid/os/RemoteException;
    .end local v14    # "serviceBinder":Landroid/os/IBinder;
    :catch_1
    move-exception v9

    .line 480
    .restart local v9    # "exce":Landroid/os/RemoteException;
    sget-object v0, Lcom/android/server/BatteryService;->TAG:Ljava/lang/String;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v8, "Permission Denial: can\'t dump Battery service from from pid="
    ...
    .line 781
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lcom/android/server/BatteryService;->dynamicallyConfigBatteryServiceLogTag(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    .local v4, "oUpdate":Z
    :try_start_0
    iget-object v7, p0, Lcom/android/server/BatteryService;->obs:Lcom/android/server/OppoBatteryService;
    ...
    invoke-virtual {v7, p1, p2, p3}, Lcom/android/server/OppoBatteryService;->dumpAddition(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    iget-boolean v9, v9, Landroid/os/BatteryProperties;->chargerAcOnline:Z
    ...
    iget-boolean v9, v9, Landroid/os/BatteryProperties;->chargerUsbOnline:Z
    ...
    const-string v9, "  Wireless powered: "
    ...
    iget-boolean v9, v9, Landroid/os/BatteryProperties;->chargerWirelessOnline:Z
    ...
    .end local v1    # "ident":J
    :cond_13
    const-string v7, "Dump current battery state, or:"

    invoke-virtual {p2, v7}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 863
    const-string v7, "  set ac|usb|wireless|status|level|invalid <value>"
