...
.method private configImeClientLogTag(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    .locals 3
    ...
    const-string v2, "Input client dead: "
    ...
    :cond_0
    const-string v1, "Current input client has error:mCurClient.client null"
    ...
    .line 3759
    :cond_1
    const-string v1, "No input client"
...
.method private configInputMehtodServiceLogTag(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    .locals 3
    .param p1, "fd"    # Ljava/io/FileDescriptor;
    .param p2, "pw"    # Ljava/io/PrintWriter;
    .param p3, "args"    # [Ljava/lang/String;
    ...
    .end local v0    # "e":Landroid/os/RemoteException;
    :cond_0
    const-string v1, "No input methd service."
...
.method private showInputMethodMenuInternal(Z)V
    ...
    check-cast v11, Lcom/oppo/widget/OppoSwitch;

    .line 2755
    .local v11, "hardKeySwitch":Lcom/oppo/widget/OppoSwitch;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v11, v0}, Lcom/oppo/widget/OppoSwitch;->setChecked(Z)V
    ...
    invoke-virtual {v11, v0}, Lcom/oppo/widget/OppoSwitch;->setOnCheckedChangeListener(Landroid/widget/CompoundButton$OnCheckedChangeListener;)V
    ...
    .end local v11    # "hardKeySwitch":Lcom/oppo/widget/OppoSwitch;
    .end local v12    # "i":I
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 3588
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lcom/android/server/InputMethodManagerService;->dynamicallyConfigImeLogTag(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)Z
...
.method protected dynamicallyConfigImeLogTag(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    .locals 7
    .param p1, "fd"    # Ljava/io/FileDescriptor;
    .param p2, "pw"    # Ljava/io/PrintWriter;
    .param p3, "args"    # [Ljava/lang/String;
    ...
    .line 3695
    invoke-virtual {p0, p2}, Lcom/android/server/InputMethodManagerService;->logOutImeLogTagHelp(Ljava/io/PrintWriter;)V
    ...
    const-string v6, "dynamicallyConfigImeLogTag, args.length:"
    ...
    const-string v6, "dynamicallyConfigImeLogTag, args["
    ...
    const-string v6, "dynamicallyConfigImeLogTag, logCategoryTag:"
    ...
    .line 3714
    sput-boolean v3, Lcom/android/server/InputMethodManagerService;->DEBUG:Z

    .line 3715
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/InputMethodManagerService;->configInputMehtodServiceLogTag(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V

    .line 3716
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/InputMethodManagerService;->configImeClientLogTag(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public getInputMethodList()Ljava/util/List;
    ...
    invoke-static {v0}, Lcom/android/internal/inputmethod/OppoIMEUtils;->getRegionFilteredInputMethodList(Ljava/util/List;)Ljava/util/List;
...
.method protected logOutImeLogTagHelp(Ljava/io/PrintWriter;)V
    .locals 1
    ...
    .line 3767
    const-string v0, "1 All ime log:IMMS, IMS, Ime2App"

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 3768
    const-string v0, "cmd: dumpsys input_method log all 0/1"
    ...
    .line 3771
    const-string v0, "2 IMMS(InputMethodManagerService) log"

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 3772
    const-string v0, "cmd: dumpsys input_method log imms 0/1"
    ...
    .line 3775
    const-string v0, "3 IMS(InputMethdService)"

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 3776
    const-string v0, "cmd: dumpsys input_method log ims 0/1"
    ...
    .line 3779
    const-string v0, "4 log between ime and app"

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 3780
    const-string v0, "cmd: dumpsys input_method log client 0/1"
