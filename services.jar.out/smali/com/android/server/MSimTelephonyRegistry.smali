...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionState:[I

    .line 232
    new-array v3, v2, [Z

    iput-object v3, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionPossible:[Z
    ...
    iput-object v3, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionLinkProperties:[Landroid/net/LinkProperties;

    .line 242
    new-array v3, v2, [Landroid/net/LinkCapabilities;

    iput-object v3, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionLinkCapabilities:[Landroid/net/LinkCapabilities;

    .line 244
    new-array v3, v2, [I

    iput-object v3, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionNetworkType:[I
    ...
    .line 261
    iget-object v3, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionState:[I
    ...
    .line 263
    iget-object v3, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionPossible:[Z

    aput-boolean v5, v3, v0

    .line 265
    iget-object v3, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionReason:[Ljava/lang/String;
    ...
    .line 267
    iget-object v3, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionApn:[Ljava/lang/String;
    ...
    .line 269
    iget-object v3, p0, Lcom/android/server/MSimTelephonyRegistry;->mConnectedApns:Ljava/util/ArrayList;
    ...
    .line 271
    iget-object v3, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionLinkProperties:[Landroid/net/LinkProperties;
    ...
    .line 273
    iget-object v3, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionLinkCapabilities:[Landroid/net/LinkCapabilities;
    ...
    .line 275
    iget-object v3, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionNetworkType:[I
...
.method private validateEventsAndUserLocked(Lcom/android/server/MSimTelephonyRegistry$Record;I)Z
    ...
    .line 1021
    :goto_0
    const-string v4, "MSimTelephonyRegistry"
    ...
    iget v6, p1, Lcom/android/server/MSimTelephonyRegistry$Record;->callerUid:I
    ...
    iget v6, p1, Lcom/android/server/MSimTelephonyRegistry$Record;->events:I
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v6, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionState:[I
    ...
    iget-object v6, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionPossible:[Z
    ...
    iget-object v6, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionNetworkType:[I
...
.method public listen(Ljava/lang/String;Lcom/android/internal/telephony/IPhoneStateListener;IZI)V
    ...
    .line 302
    .local v7, "myUid":I
    const-string v11, "MSimTelephonyRegistry"
    ...
    const-string v14, "listen: mCellLocation="
    ...
    iget-object v13, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionState:[I

    aget v13, v13, p5

    iget-object v14, p0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionNetworkType:[I
    ...
    const-string v14, "listen: mCellInfo["
    ...
    iget-object v14, p0, Lcom/android/server/MSimTelephonyRegistry;->mCellInfo:Ljava/util/ArrayList;
...
.method public notifyCellLocation(Landroid/os/Bundle;I)V
    ...
    const-string v6, "notifyCellLocation: mCellLocation="
...
.method public notifyDataConnection(IZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/LinkCapabilities;IZI)V
    ...
    invoke-direct {v0, v1}, Lcom/android/server/MSimTelephonyRegistry;->checkNotifyPermission(Ljava/lang/String;)Z
    ...
    iget-object v3, v0, Lcom/android/server/MSimTelephonyRegistry;->mRecords:Ljava/util/ArrayList;
    ...
    iget-object v2, v0, Lcom/android/server/MSimTelephonyRegistry;->mRecords:Ljava/util/ArrayList;
    ...
    iget-object v1, v0, Lcom/android/server/MSimTelephonyRegistry;->mConnectedApns:Ljava/util/ArrayList;
    ...
    iget-object v1, v0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionState:[I
    ...
    iget-object v1, v0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionPossible:[Z

    aput-boolean p2, v1, p10

    .line 679
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionReason:[Ljava/lang/String;

    aput-object p3, v1, p10

    .line 680
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionLinkProperties:[Landroid/net/LinkProperties;

    aput-object p6, v1, p10

    .line 681
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionLinkCapabilities:[Landroid/net/LinkCapabilities;

    aput-object p7, v1, p10

    .line 682
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionNetworkType:[I
    ...
    iget-object v4, v0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionState:[I
    ...
    iget-object v4, v0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionNetworkType:[I
    ...
    iget-object v1, v0, Lcom/android/server/MSimTelephonyRegistry;->mRecords:Ljava/util/ArrayList;
    ...
    check-cast v18, Lcom/android/server/MSimTelephonyRegistry$Record;

    .line 707
    .local v18, "r":Lcom/android/server/MSimTelephonyRegistry$Record;
    move-object/from16 v0, v18

    iget v1, v0, Lcom/android/server/MSimTelephonyRegistry$Record;->events:I
    ...
    iget v1, v0, Lcom/android/server/MSimTelephonyRegistry$Record;->subscription:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v4, "guixiang-duyh-Notify data connection state changed on sub: "
    ...
    iget-object v1, v0, Lcom/android/server/MSimTelephonyRegistry$Record;->callback:Lcom/android/internal/telephony/IPhoneStateListener;

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionState:[I
    ...
    iget-object v1, v0, Lcom/android/server/MSimTelephonyRegistry;->mRemoveList:Ljava/util/ArrayList;

    move-object/from16 v0, v18

    iget-object v3, v0, Lcom/android/server/MSimTelephonyRegistry$Record;->binder:Landroid/os/IBinder;
    ...
    .end local v18    # "r":Lcom/android/server/MSimTelephonyRegistry$Record;
    :catchall_0
    move-exception v1
    ...
    :cond_6
    invoke-direct/range {p0 .. p0}, Lcom/android/server/MSimTelephonyRegistry;->handleRemoveListLocked()V
    ...
    .line 744
    .local v12, "defaultApnTypes":[Ljava/lang/String;
    if-eqz p4, :cond_b
    ...
    const-string v2, "notifyDataConnection apn != null"
    ...
    aget-boolean v3, v1, p10

    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionReason:[Ljava/lang/String;

    aget-object v4, v1, p10

    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionLinkProperties:[Landroid/net/LinkProperties;

    aget-object v7, v1, p10

    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/server/MSimTelephonyRegistry;->mDataConnectionLinkCapabilities:[Landroid/net/LinkCapabilities;

    aget-object v8, v1, p10
    ...
    .line 757
    .end local v12    # "defaultApnTypes":[Ljava/lang/String;
    :cond_9
    if-nez v16, :cond_0
    ...
    const-string v2, "notifyDataConnection apnType == default or mms"
    ...
    .line 750
    .restart local v12    # "defaultApnTypes":[Ljava/lang/String;
    :cond_b
    const/4 v14, 0x0
    ...
    const-string v3, "notifyDataConnection defaultApnTypes = "
