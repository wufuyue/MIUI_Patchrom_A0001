...
.method private prepareNativeDaemon()V
    ...
    const-string v9, "/proc/net/xt_qtaguid/ctrl"
    ...
    .line 357
    .local v3, "hasKernelSupport":Z
    if-eqz v3, :cond_1

    .line 358
    const-string v8, "NetworkManagementService"

    const-string v9, "enabling bandwidth control"
    ...
    invoke-virtual {v8, v9, v12}, Lcom/android/server/NativeDaemonConnector;->execute(Ljava/lang/String;[Ljava/lang/Object;)Lcom/android/server/NativeDaemonEvent;

    .line 361
    const/4 v8, 0x1

    iput-boolean v8, p0, Lcom/android/server/NetworkManagementService;->mBandwidthControlEnabled:Z
    :try_end_0
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_0 .. :try_end_0} :catch_1

    .line 372
    :goto_0
    const-string v9, "net.qtaguid_enabled"

    iget-boolean v8, p0, Lcom/android/server/NetworkManagementService;->mBandwidthControlEnabled:Z
    ...
    invoke-interface {v8}, Lcom/android/internal/app/IBatteryStats;->noteNetworkStatsEnabled()V
    :try_end_1
    ...
    .line 384
    :try_start_2
    iget-object v8, p0, Lcom/android/server/NetworkManagementService;->mActiveQuotas:Ljava/util/HashMap;
    ...
    iput-object v8, p0, Lcom/android/server/NetworkManagementService;->mActiveQuotas:Ljava/util/HashMap;
    ...
    invoke-virtual {p0, v8, v13, v14}, Lcom/android/server/NetworkManagementService;->setInterfaceQuota(Ljava/lang/String;J)V
    ...
    const-string v9, "not enabling bandwidth control"
    ...
    :cond_3
    :try_start_3
    iget-object v8, p0, Lcom/android/server/NetworkManagementService;->mActiveAlerts:Ljava/util/HashMap;
    ...
    iput-object v8, p0, Lcom/android/server/NetworkManagementService;->mActiveAlerts:Ljava/util/HashMap;
    ...
    invoke-virtual {p0, v8, v13, v14}, Lcom/android/server/NetworkManagementService;->setInterfaceAlert(Ljava/lang/String;J)V
    ...
    iput-object v8, p0, Lcom/android/server/NetworkManagementService;->mUidRejectOnQuota:Landroid/util/SparseBooleanArray;
    ...
    invoke-virtual {p0, v8, v9}, Lcom/android/server/NetworkManagementService;->setUidNetworkRules(IZ)V
    ...
    .line 416
    iget-boolean v8, p0, Lcom/android/server/NetworkManagementService;->mFirewallEnabled:Z
    ...
    :goto_6
    invoke-virtual {p0, v8}, Lcom/android/server/NetworkManagementService;->setFirewallEnabled(Z)V
