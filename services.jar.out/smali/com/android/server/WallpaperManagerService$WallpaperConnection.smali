...
.method public attachEngine(Landroid/service/wallpaper/IWallpaperEngine;)V
    ...
    invoke-static {v1, v3}, Lcom/android/server/WallpaperManagerService;->access$500(Lcom/android/server/WallpaperManagerService;Lcom/android/server/WallpaperManagerService$WallpaperData;)V
...
.method public onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->CHANGE_CODE:Landroid/annotation/OppoHook$OppoHookType;
        note = "TianYuan@Plf.Launcher, 2015.02.05: change for oppo-wallpaper"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
    ...
    .line 521
    iget-object v1, p0, Lcom/android/server/WallpaperManagerService$WallpaperConnection;->mWallpaper:Lcom/android/server/WallpaperManagerService$WallpaperData;

    iget-object v1, v1, Lcom/android/server/WallpaperManagerService$WallpaperData;->connection:Lcom/android/server/WallpaperManagerService$WallpaperConnection;
    ...
    iget-boolean v1, v1, Lcom/android/server/WallpaperManagerService$WallpaperData;->wallpaperUpdating:Z

    if-nez v1, :cond_1

    iget-object v1, p0, Lcom/android/server/WallpaperManagerService$WallpaperConnection;->mWallpaper:Lcom/android/server/WallpaperManagerService$WallpaperData;

    iget-wide v3, v1, Lcom/android/server/WallpaperManagerService$WallpaperData;->lastDiedTime:J
    ...
    iget v1, v1, Lcom/android/server/WallpaperManagerService$WallpaperData;->userId:I
    ...
    iget v4, v4, Lcom/android/server/WallpaperManagerService$WallpaperData;->userId:I

    const/4 v5, 0x0

    invoke-virtual {v1, v3, v4, v5}, Lcom/android/server/WallpaperManagerService;->clearWallpaperLocked(ZILandroid/os/IRemoteCallback;)V
    ...
    const-string v3, "onServiceDisconnected : restore wallpaper from wallpaperservice die"
    ...
    invoke-virtual {v1, v0, v3}, Lcom/android/server/WallpaperManagerService;->switchWallpaper(Lcom/android/server/WallpaperManagerService$WallpaperData;Landroid/os/IRemoteCallback;)V
