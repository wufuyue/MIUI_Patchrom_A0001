...
------------------------------
usf_epos_treat_sw2_as_sw0               -        Ref3 has a bug that routs side switch to the wrong input in asic.
                                                 Therefore Ref3 reports side switch as SW0 instead of SW2.
                                                 This parameter is used to workaround this issue.
                                                 [1] treat sw2 as sw0. [0] (default) treat SW2 as is.
