...
.method protected constructor <init>(Ljava/lang/String;Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Z)V
    ...
    iput v1, p0, Lcom/android/internal/telephony/PhoneBase;->emTelIndex:I
...
.method private getEmCallStatus(Lcom/android/internal/telephony/DriverCall$State;)I
    ...
    .line 2125
    sget-object v1, Lcom/android/internal/telephony/PhoneBase$1;->$SwitchMap$com$android$internal$telephony$DriverCall$State:[I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 442
    sput v5, Lcom/android/internal/telephony/PhoneBase;->mRingnumbers:I
    ...
    sget v2, Lcom/android/internal/telephony/PhoneBase;->mRingnumbers:I

    add-int/lit8 v3, v2, 0x1

    sput v3, Lcom/android/internal/telephony/PhoneBase;->mRingnumbers:I
    ...
    const-string v3, "Event OPPO_EVENT_GET_MDM_VERSION_DONE Received"
    ...
    const-string v3, "get modem version failed"
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/PhoneBase;->mMdmVersion:Ljava/lang/String;
    ...
    const-string v4, "mdm version:"

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p0, Lcom/android/internal/telephony/PhoneBase;->mMdmVersion:Ljava/lang/String;
    ...
    const-string v3, "OPPO failed to EVENT_EM_DIAL_DONE."
    ...
    invoke-direct {p0, v5, v2}, Lcom/android/internal/telephony/PhoneBase;->notifyEMTCallStatus(ILjava/lang/String;)V
    ...
    const-string v3, "OPPO succeed to EVENT_EM_DIAL_DONE."
    ...
    const-string v3, "OPPO receive EVENT_EM_CALL_STATUS_CHANGED."
    ...
    const-string v3, "OPPO failed to EVENT_EM_GET_CURRENT_CALLS_DONE."
    ...
    const-string v3, "OPPO failed to EVENT_EM_HANGUP_DONE."

    invoke-static {v2, v3}, Landroid/telephony/Rlog;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 543
    iget v2, p0, Lcom/android/internal/telephony/PhoneBase;->hangup_retry_count:I

    add-int/lit8 v2, v2, 0x1

    iput v2, p0, Lcom/android/internal/telephony/PhoneBase;->hangup_retry_count:I
    ...
    invoke-interface {v2, v3}, Lcom/android/internal/telephony/CommandsInterface;->hangupForegroundResumeBackground(Landroid/os/Message;)V
    ...
    const-string v3, "OPPO succeed to EVENT_EM_HANGUP_DONE."
