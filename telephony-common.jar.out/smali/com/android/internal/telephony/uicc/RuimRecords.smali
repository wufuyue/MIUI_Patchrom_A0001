...
.method private fetchRuimRecords()V
    ...
    new-instance v2, Lcom/android/internal/telephony/uicc/RuimRecords$EfAdLoaded;

    invoke-direct {v2, p0, v5}, Lcom/android/internal/telephony/uicc/RuimRecords$EfAdLoaded;-><init>(Lcom/android/internal/telephony/uicc/RuimRecords;Lcom/android/internal/telephony/uicc/RuimRecords$1;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 675
    :sswitch_7
    const-string v7, "yangli"

    const-string v8, "EVENT_GET_POL_DONE"
    ...
    const-string v9, "Exception in fetching EF POL data"
    ...
    const-string v8, "Exception in fetching EF POL data "
    ...
    .line 682
    iget-object v7, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mFh:Lcom/android/internal/telephony/uicc/IccFileHandler;

    const/16 v8, 0x6f30

    const/16 v9, 0x63

    iget-object v10, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->onCompleteMsg:Landroid/os/Message;

    invoke-virtual {p0, v9, v10}, Lcom/android/internal/telephony/uicc/RuimRecords;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v9

    invoke-virtual {v7, v8, v9}, Lcom/android/internal/telephony/uicc/IccFileHandler;->loadEFTransparent(ILandroid/os/Message;)V
    ...
    const-string v9, "EVENT_GET_POL_DONE data "
    ...
    .line 693
    .local v6, "msgtarget":Landroid/os/Message;
    invoke-direct {p0, v2, v6}, Lcom/android/internal/telephony/uicc/RuimRecords;->handleEfPOLResponse([BLandroid/os/Message;)V
    ...
    .end local v1    # "ar":Landroid/os/AsyncResult;
    .end local v2    # "data":[B
    .end local v6    # "msgtarget":Landroid/os/Message;
    :sswitch_8
    const/4 v7, 0x1

    iput-boolean v7, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->eventGetPolError:Z
    ...
    iput-boolean v7, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->eventSetPolError:Z
    ...
    const-string v8, "EVENT_SET_POL_DONE"
    ...
    const-string v9, "Exception in EVENT_SET_POL_DONE EF POL data"
    ...
    const-string v8, "Exception in EVENT_SET_POL_DONE EF POL data "
    ...
    .line 717
    .restart local v6    # "msgtarget":Landroid/os/Message;
